...
public class HttpParam {
    ...
    public static TreeMap<String, String> getNormalParamsMapWithRP(String method) {
        TreeMap<String, String> lMap = new TreeMap<>();
        lMap.put(PARAMS_MODULE, "rcomp");
        lMap.put(PARAMS_METHOD, method);
        lMap.put(PARAMS_SERVICE, "PollingSendOrder");
        lMap.put(PARAMS_IMEI, SysServiceUtils.getIMEI());
        return lMap;
    }
    ...
    public static TreeMap<String, String> securityKeyMethodEnc(TreeMap<String, String> tMap) {
        tMap.put("appId", Major.eUtil.binstrToStr(BuildConfig.APP_ID));
        tMap.put("ve", "2");
    ...
    public static EparkEncrypUtil eUtil = EncryptionUtilFactory.getDefault(BuildConfig.DEBUG).createEpark();
    ...
    public static TreeMap<String, String> getSecurityMapKeys(TreeMap<String, String> tMap, boolean isEnCode, boolean isSign) {
        ...
        if (!TextUtils.isEmpty(BuildConfig.APP_ID)) {
            tMap.put("ve", "2");
            if (isSign) {
                tMap.put("appId", StringUtils.BinstrToStr(BuildConfig.APP_ID));
            } else {
                tMap.put("appId", "");
            }
        }
        ...
        parmas = DataFormatUtil.addText(lStringBuilder, parmas, "requestKey=",
                StringUtils.BinstrToStr(BuildConfig.REQUEST_KEY));
